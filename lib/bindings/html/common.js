...
(function () {
  ...
  /* IMPORTANT: Keep these two functions (readOnlyBinder and binder) in sync.
   * Not sure if want to factor out their comment code - it would result in
   * more function calls and branches. */
  ...
  /* IMPORTANT: See the note for readOnlyBinder. */
