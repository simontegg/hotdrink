...
(function () {
  ...
  function shouldBeExecuted (m, sgraph, egraph) {
    ...
    return (sgraph.planDiff.include(m)) ? (true) : (
    ...
    eval1 : function (v) {
      ...
      if (!ev.isComputed) {
        ...
        if (m !== "") {
          ...
          if (shouldBeExecuted(m, this.sgraph, this.egraph)) {
            this.egraph.methods.get(m).inputs.each(function (pair) {
            ...
            this.caller = m;
            var results = this.egraph.methods.get(m).execute(this);
