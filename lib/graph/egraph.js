...
(function () {
  ...
  var initializeValue = function (model, v) {
    var expr = model.variables[v].initExpr;
    var value = null;
  ...
  var EGraph = {
    ...
    initialize : function (cgraph, methodRegistry, inputs) {
      ...
      Object.keys(this.variables).forEach(function (v) {
        this.variables[v].hasBeenEdited = false;
      }, this);

      Object.keys(this.methods).each(function (m) {
        var mm = this.methods[m];
        /* Which inputs I used the last time I ran. Before the first evaluation,
         * pretend that I needed all of them. */
      ...
      Object.keys(inputs).forEach(function (v) {
        ...
        vv.initExpr = Object.toJSON(inputs[v]);
      }, this);
