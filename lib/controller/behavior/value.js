...
var bindWriteListener = function (model, write, v, view) {
    ...
    registry.each(function (item) {
      ...
      var binder = function (model, view, options) {
        ...
        if (options.readonly) {
          ...
          if (writeOnly) {
            bindWriteListener(model, writeOnly, v, view);
          } else if (write) {
            bindWriteListener(model, write, v, view);
          } else {
            ERROR(type + " is readonly but unwriteable");
          }
          ...
          if (read) {
            ...
            ERROR(type + " is unreadable");
          }

          if (write) {
            bindWriteListener(model, write, v, view);
          } else {
            WARNING(type + " is unwriteable");
          }
