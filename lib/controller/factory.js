...
(function () {
  ...
  /** @lends hotdrink.controller.Factory# */
  {
     ...
     *
     * <p>
     * Two kinds of visitor are supported for the two kinds of manufacturing:
     * compile and build. Each widget type may only have one compile and one
     * build visitor. New registrants of such visitors will replace their
     * predecessors. The same visitor can be registered to multiple widget
     * types by passing an array of names in the type field.
     * </p>
     *
